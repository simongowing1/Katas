...
// The arguments in this case are the variables from the iterations in the two for loops above (year, month).
// The final argument (0) denotes the last day of the selected month
      let day = new Date(year, month, 0);

// If the variable 'day' is the fifth day of the week (Friday) then increase the counter 'totalFridays'
      if (day.getDay() === 5) {
        totalFridays++;
      }
    }
