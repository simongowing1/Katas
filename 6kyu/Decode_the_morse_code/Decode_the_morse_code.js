...
// codes and 3 spaces are used to separate words. For example, the message HEY JUDE in
// Morse code is ···· · −·−−   ·−−− ··− −·· ·.
...
export function decodeMorse(morseCode) {
  ...
  const translatedArray = splitString.map((letter) =>
