...
//CORRECT SOLTION
//(full disclosure, the pop() and switch statement at the end was something that was inspired by another's solution. It makes the solution scalable rather than restricted by the complexity of the argument)
...
function calc(expr) {
    ...
    for (let i = 0; i < splitString.length; i++) {
      ...
      if (typeof splitString[i] === 'number') stack.push(splitString[i]);
        ...
        //take the last index of the stack (the value of the previous index), remove it and store it as the variable 'a'
        let a = stack.pop();
        //then take the previous index of the stack (the value of the previous index), remove it and store it as the variable 'b'
        let b = stack.pop();
...
//ORIGINAL SOLUTION
//(Doesn't pass all tests because it can't handle expressions more complicated than <number number operator>)
